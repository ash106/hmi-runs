...
class WorkoutsControllerTest < ActionController::TestCase
  ...
  test "should create workout" do
    assert_difference('Workout.count') do
      post :create, workout: { date_of: @workout.date_of, length: @workout.length, user_id: @workout.user_id }
    end
  ...
  test "should update workout" do
    patch :update, id: @workout, workout: { date_of: @workout.date_of, length: @workout.length, user_id: @workout.user_id }
    assert_redirected_to workout_path(assigns(:workout))
  end
